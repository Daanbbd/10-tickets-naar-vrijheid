...
MAPPING = [
    ...
    ("GRIJS", "ui_grijs", "neutrale derivaat — GEEN tekstkleur, haalt 4,5:1 nergens"),
    ("GRIJS_OP_LICHT", "ui_grijs_op_licht", "secundaire tekst op een licht vlak — PANEL, WIT, PAPIER, POSTIT"),
    ("GRIJS_OP_DONKER", "lichtgrijs", "secundaire tekst op een donker vlak — PANEL_DARK, INK, de startschermen"),
    ("WIT", "wit", "neutraal"),
    ...
    ("GROEN", "ui_groen", "derivaat van bb-green, leesbaar op 8-10px — DONKERE ondergrond, zie GROEN_OP_LICHT"),
    ("GROEN_TINT", "bb_green", "letterlijk bb-green"),
    ("GROEN_OP_LICHT", "ui_groen_op_licht", "GROEN op een lichte ondergrond — het scrumbord, de titelscherm-bevestiging"),
    ("ROOD", "ui_rood", "game-only utility — BBD heeft geen foutkleur — DONKERE ondergrond, zie ROOD_OP_LICHT"),
    ("ROOD_OP_LICHT", "ui_rood_op_licht", "ROOD op een lichte ondergrond — zelfde reden als GROEN_OP_LICHT"),
    ("ORANJE", "ui_oranje", "derivaat van bb-orange, leesbaar op 8-10px — alleen nog 'doel'"),
    ("VASTGEZET", "ui_vastgezet", "rand om een vastgeprikt ticket"),
    ("OVERWERK", "ui_overwerk", "de klok voorbij het urenbudget"),
    ("GEBOEKT", "ui_geboekt", "tijd die zojuist geboekt is"),
    ...
    ("MUUR", "muur", "de muur van het kantoor, ook op het selectiepodium"),
    ("SCHERM_NACHT", "ui_scherm_nacht", "ondergrond van titel- en uitlegscherm"),
    ("SCHERM_DIEP", "ui_scherm_diep", "ondergrond van de aftiteling, één tint dieper"),
    ("PAPIER", "ui_papier", "een papieren vlak in een minigame"),
    ("VAK_LEEG", "ui_vak_leeg", "een ticketvakje dat niet van jou is"),
